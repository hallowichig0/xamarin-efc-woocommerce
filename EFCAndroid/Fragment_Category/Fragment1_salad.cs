...
{
    public class Fragment1_salad : SupportFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            string[] get_id_name = new string[] { "FUNKY FRUIT SALAD", "MEDITERESIAN CHICKEN SALAD", "SALAD NICOISE", };
            string[] get_img = new string[] { "http://soleimer.com/EFC_IMAGES_MOBILE/CATEGORY/salad/FUNKY-FRUIT-SALAD.png", "http://soleimer.com/EFC_IMAGES_MOBILE/CATEGORY/salad/MEDITERESIAN-CHICKEN-SALAD.png",
            "http://soleimer.com/EFC_IMAGES_MOBILE/CATEGORY/salad/SALAD-NICOISE.png" };
