...
{
    public class Fragment_pasta : SupportFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            string[] get_id_name = new string[] { "CHEESY COLD PASTA", "PESTO PASTA WITH CHICKEN BREAST", "SEAFOOD MARINARA" };
            string[] get_img = new string[] { "http://soleimer.com/EFC_IMAGES_MOBILE/CATEGORY/pasta/CHEESY-COLD-PASTA.png", "http://soleimer.com/EFC_IMAGES_MOBILE/CATEGORY/pasta/PESTO-PASTA-WITH-CHICKEN-BREAST.png",
            "http://soleimer.com/EFC_IMAGES_MOBILE/CATEGORY/pasta/SEAFOOD-MARINARA.png" };
