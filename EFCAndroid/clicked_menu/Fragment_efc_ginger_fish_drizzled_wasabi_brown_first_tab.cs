...
{
    public class Fragment_efc_ginger_fish_drizzled_wasabi_brown_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/GingerFishPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/GingerFishPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/GingerFishPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_ginger_fish_drizzled_wasabi_brown_first_tab, container, false);
            ...
            txtproduct_title.Text = "GINGER FISH DRIZZLED WITH WASABI SERVED WITH BROWN RICE";
            txtprice.Text = "\n₱275.00";
            txtcontent.Text = "\nThe EFC Ginger fish drizzled with wasabi served with brown rice is an original fish meal that is inspired by Japanese cuisine. It is a well-seasoned tuna fish fillet with a hint of Japanese wasabi. This dish is great for those who wish to stay healthy and fit with well-balanced meal. It is a flavor like no other and worth trying.";
