...
{
    [Activity(Label = "Activity_EFC_ARROZ_CUBANA_GARLIC_MUSHROOM_SPINACH", /*MainLauncher = true,*/ Theme = "@style/Theme.DesignDemo")]
    public class Activity_EFC_ARROZ_CUBANA_GARLIC_MUSHROOM_SPINACH : AppCompatActivity
    {
        int[] imgview =
        {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_efc_arroz_cubana_garlic_mushroom_spinach);

            mToolbar = FindViewById<SupportToolbar>(Resource.Id.toolbar);

            SetSupportActionBar(mToolbar);
            SupportActionBar.Title = "ARROZ ALA CUBANA WITH GARLIC MUSHROOM SPINACH";
        ...
        private void SetUpViewPager(ViewPager viewpager)
        {
            ...
            adapter.AddFragment(new Fragment_efc_arroz_cubana_garlic_mushroom_spinach_first_tab(), "Product");
        ...
        private void BottomNavView_NavigationItemSelected(object sender, BottomNavigationView.NavigationItemSelectedEventArgs e)
        {
            ...
            new System.Threading.Thread(new System.Threading.ThreadStart(delegate
            {
                ...
                try
                {
                    ...
                    MySqlCommand cmd_select = new MySqlCommand("select count(*) from wp_product_cart INNER JOIN wp_product_cart_add_ons ON wp_product_cart.session_order_id = wp_product_cart_add_ons.session_order_id where wp_product_cart.product_name = 'ARROZ ALA CUBANA WITH GARLIC MUSHROOM SPINACH' AND wp_product_cart_add_ons.key_same_result = '1' AND wp_product_cart.customer_name = '" + session_user + "';", conn);
                    ...
                    if (count > 0)
                    {
                       ...
                       "WHERE wp_product_cart_add_ons.key_same_result = '1' AND wp_product_cart.product_name = 'ARROZ ALA CUBANA WITH GARLIC MUSHROOM SPINACH' AND wp_product_cart.customer_name = '" + session_user + "';";
                    ...
                    else
                    {
                        ...
                        cmd_insert.Parameters.Add("@product_name", MySqlDbType.VarChar).Value = "ARROZ ALA CUBANA WITH GARLIC MUSHROOM SPINACH";
                        ...
                        cmd_insert.Parameters.Add("@image", MySqlDbType.VarChar).Value = "http://earthfashioncafe.com/wp-content/uploads/2018/01/ArrozAlaCubanaPackaging-180x180.png";
