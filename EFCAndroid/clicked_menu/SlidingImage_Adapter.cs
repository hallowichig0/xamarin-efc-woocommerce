...
namespace EFCAndroid
{
    public class SlidingImage_Adapter : PagerAdapter
    {
        ...
        public SlidingImage_Adapter(Context context, string[] gridViewImage)
        {
        ...
        public override Java.Lang.Object InstantiateItem(ViewGroup container, int position)
        {
            ...
            View view = layoutInflater.Inflate(Resource.Layout.custom_layout_for_sliderViewPager, null);
