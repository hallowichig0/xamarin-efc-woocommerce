...
{
    public class Fragment_efc_chicken_teriyaki_first_tab : SupportFragment
    {
        ...
        {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/chickenteriyaki-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2017/09/chickenteriyakiedited1-600x397.jpg",
            "http://earthfashioncafe.com/wp-content/uploads/2017/09/chickenteriyakisideview-600x397.jpg"
        };
        ...
        {
            "http://earthfashioncafe.com/wp-content/uploads/2017/09/chickenteriyakiFullRiceMeal.jpg",
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_chicken_teriyaki_first_tab, container, false);
            ...
            txtproduct_title.Text = "EFC CHICKEN TERIYAKI";
            txtprice.Text = "\n₱179.00";
...
"\n\nWe have also added garden - fresh bean sprouts as well as the sweet and crisp carrots, perfect for your healthy lifestyle without sabotaging the delicious taste in it." +
  "\n\nEFC used breast part of the chicken for more white meat, without skin and for lesser bone";
            ...
            gridview.ItemClick += (object sender, AdapterView.ItemClickEventArgs e) =>
            {
                ...
                switch (e.Position)
                {
                    ...
                    case 0:
                        zoom_imgview[0] = "http://earthfashioncafe.com/wp-content/uploads/2017/09/chickenteriyakiFullRiceMeal.jpg";
                    ...
                    case 1:
                        ...
                        zoom_imgview[2] = "http://earthfashioncafe.com/wp-content/uploads/2017/09/chickenteriyakiFullRiceMeal.jpg";
                    ...
                    case 2:
                        ...
                        zoom_imgview[1] = "http://earthfashioncafe.com/wp-content/uploads/2017/09/chickenteriyakiFullRiceMeal.jpg";
