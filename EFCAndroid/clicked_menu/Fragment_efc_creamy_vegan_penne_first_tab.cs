...
{
    public class Fragment_efc_creamy_vegan_penne_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/CreamyVeganPennePackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/CreamyVeganPennePackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/CreamyVeganPennePlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_creamy_vegan_penne_first_tab, container, false);
            ...
            txtproduct_title.Text = "CREAMY VEGAN PENNE";
            txtprice.Text = "\n₱185.00";
            txtcontent.Text = "\nThe EFC Creamy Vegan Penne is a promising meal inspired by French cuisine. A well-made vegan dish of pasta smothered in special sauce and blended by a variety of healthy mixed greens.This dish is a great and extraordinary dish for those who wish to keep healthy and energetic.";
