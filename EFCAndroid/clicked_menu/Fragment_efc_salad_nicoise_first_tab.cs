...
{
    public class Fragment_efc_salad_nicoise_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/SaladNiscoisePackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/SaladNiscoisePackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/SaladNiscoisePlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_salad_nicoise_first_tab, container, false);
            ...
            txtproduct_title.Text = "SALAD NICOISE";
            txtprice.Text = "\n₱245.00";
            txtcontent.Text = "\nSalad Nicoise is loaded with fresh mixed greens, tomatoes, hard-boiled egg, simmered potatoes, olives, drizzled with balsamic dressings topped either with shrimp or pan grilled chicken of your choice.";
