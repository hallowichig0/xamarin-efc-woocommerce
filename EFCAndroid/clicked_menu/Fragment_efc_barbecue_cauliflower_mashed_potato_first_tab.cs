...
{
    public class Fragment_efc_barbecue_cauliflower_mashed_potato_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/BarbecueCauliFlowerPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/BarbecueCauliFlowerPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/BarbecueCauliFlowerPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_barbecue_cauliflower_mashed_potato_first_tab, container, false);
            ...
            txtproduct_title.Text = "BARBECUE CAULIFLOWER WITH MASHED POTATO";
            txtprice.Text = "\n₱185.00";
            txtcontent.Text = "\nThe EFC Barbecue Cauliflower with mashed potato is a unique vegan dish with a great twist of American style cooking. A well-seasoned cauliflower drizzled gracefully in barbecue sauce blended by a variety of mixed vegetables and a side dish of mashed potato. This dish is great for those who wish to stay healthy and fit with a great balance of carbohydrates, protein, and great taste.";
