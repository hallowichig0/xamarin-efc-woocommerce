...
{
    public class Fragment_efc_chimichurri_fish_rice_mix_greens_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/ChimichurriFishPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/ChimichurriFishPackagingFrontView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/ChimichurriFish-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_chimichurri_fish_rice_mix_greens_first_tab, container, false);
            ...
            txtproduct_title.Text = "CHIMICHURRI FISH WITH RICE AND MIX GREENS";
            txtprice.Text = "\n₱225.00";
            txtcontent.Text = "\nThe EFC Chimichurri fish with rice and mix greens is a beautiful meal of exquisite taste. It is a well-seasoned tuna fish fillet with a hint of Japanese wasabi. It is served and smothered with a variety of mixed greens and a hint of special flavor. This dish is great for those who wish to stay healthy and fit with a well-balanced meal.";
