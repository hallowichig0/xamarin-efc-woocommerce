...
{
    public class Fragment_efc_funky_fruit_salad_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/FunkyFruitSaladPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/FunkyFruitSaladPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/FunkyFruitSaladPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_funky_fruit_salad_first_tab, container, false);
            ...
            txtproduct_title.Text = "FUNKY FRUIT SALAD";
            txtprice.Text = "\n₱195.00";
            txtcontent.Text = "\nEFC Funky fruit salad is a flavorful blend of freshest fruits and veggies, prepared with Al dente macaroni in one healthy complete dish. Experience the bursting flavours in the mix of delicious dressing and freshest zest of fruits. Get some carbs without that extra flabs.";
