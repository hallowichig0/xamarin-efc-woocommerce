...
{
    public class Fragment_efc_chicken_tikka_pan_grill_banana_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/ChickenTikkaPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/ChickenTikkaPackagingFrontView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/ChickenTikka-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_chicken_tikka_pan_grill_banana_first_tab, container, false);
            ...
            txtproduct_title.Text = "CHICKEN TIKKA WITH PAN GRILL BANANA WITH MIX GREENS";
            txtprice.Text = "\n₱335.00";
            txtcontent.Text = "\nThe EFC Chicken Tikka W/ Pan Grill Banana & Mixed Greens is a TASTY and HEALTHY dish! A delish best for a healthy you! Cooked with the freshest chicken breast marinated with the finest ingredients together with the peppery flavor of tika dressing. Combined with the sweet taste of saba banana and a variety of crisp garden-fresh green vegetables. A delightful dish to start your day!";
