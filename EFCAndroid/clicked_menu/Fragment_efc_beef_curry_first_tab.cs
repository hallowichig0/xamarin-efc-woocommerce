...
{
    public class Fragment_efc_beef_curry_first_tab : SupportFragment
    {
        ...
        {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/beefcurry-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2017/06/beefcurryedited1-600x397.jpg",
            "http://earthfashioncafe.com/wp-content/uploads/2017/09/beefcurrysideview-600x397.jpg"
        };
        ...
        {
            "http://earthfashioncafe.com/wp-content/uploads/2017/09/beefcurryFullRiceMeal.jpg",
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_beef_curry_first_tab, container, false);
            ...
            txtproduct_title.Text = "EFC BEEF CURRY";
            txtprice.Text = "\n₱199.00";
            txtcontent.Text = "\nEarth Fashion Cafe Beef Curry is produced with the most premium ingredients such as the mildly aromatic with pungent taste of turmeric, the fresh sour taste of lemon, pepper, with a dash of premium salt, garlic, with the luscious flavorful onion, olive oil, seasoned with tender beef." +
  ...
  "\n\nIngredients are guaranteed home-made.";
            ...
            gridview.ItemClick += (object sender, AdapterView.ItemClickEventArgs e) =>
            {
                ...
                switch (e.Position)
                {
                    ...
                    case 0:
                        zoom_imgview[0] = "http://earthfashioncafe.com/wp-content/uploads/2017/09/beefcurryFullRiceMeal.jpg";
                    ...
                    case 1:
                        ...
                        zoom_imgview[2] = "http://earthfashioncafe.com/wp-content/uploads/2017/09/beefcurryFullRiceMeal.jpg";
                    ...
                    case 2:
                        ...
                        zoom_imgview[1] = "http://earthfashioncafe.com/wp-content/uploads/2017/09/beefcurryFullRiceMeal.jpg";
