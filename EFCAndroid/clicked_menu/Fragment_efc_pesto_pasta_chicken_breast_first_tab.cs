...
{
    public class Fragment_efc_pesto_pasta_chicken_breast_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/PestoPastaPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/PestoPastaPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/PestoPastaPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_pesto_pasta_chicken_breast_first_tab, container, false);
            ...
            txtproduct_title.Text = "PESTO PASTA WITH CHICKEN BREAST";
            txtprice.Text = "\n₱275.00";
            txtcontent.Text = "\nPesto pasta with chicken breast is a savory flavor of basil, garlic, and spices embodying your favorite Italian cuisine. Partnered best with EFC’s juicy, flavourful, and perfectly grilled chicken breast.";
