...
{
    public class Fragment_efc_roasted_squash_tofu_pumpkin_puree_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/RoastedSquashPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/RoastedSquashPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/RoastedSquashPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_roasted_squash_tofu_pumpkin_puree_first_tab, container, false);
            ...
            txtproduct_title.Text = "ROASTED SQUASH AND TOFU WITH PUMPKIN PUREE";
            txtprice.Text = "\n₱185.00";
            txtcontent.Text = "\nThe EFC Roasted squash and tofu with pumpkin puree is an exquisite meal of healthy ingredients. Perfect for people who wish to try something bold and new. It is a well-seasoned squash blended with a variety of mixed greens and tofu. This beautiful dish is great for those who wish to stay healthy and fit with a well-balanced meal.";
