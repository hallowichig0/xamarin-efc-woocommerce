...
{
    public class Fragment_efc_mediteresian_chicken_salad_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/MediteresianChickenPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/MediteresianChickenPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/MediteresianChickenPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_mediteresian_chicken_salad_first_tab, container, false);
            ...
            txtproduct_title.Text = "MEDITERESIAN CHICKEN SALAD";
            txtprice.Text = "\n₱225.00";
            txtcontent.Text = "\nMediteresian Chicken Salad is a fusion of the taste of Mediterranean and Asian flavours in one. Simmered slowly to tenderized and extract the natural juice of the chicken, pan-grilled afterwards for a richer taste complemented by balsamic dressings and almond flakes.";
