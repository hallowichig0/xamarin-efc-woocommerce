...
{
    public class Fragment_efc_balsamic_beef_onion_confit_served_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/BalsamicBeefPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/BalsamicBeefPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/BalsamicBeef-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_balsamic_beef_onion_confit_served_first_tab, container, false);
            ...
            txtproduct_title.Text = "BALSAMIC BEEF WITH ONION CONFIT SERVED WITH MIX GREENS";
            txtprice.Text = "\n₱275.00";
            txtcontent.Text = "\nThe EFC Balsamic beef with onion confit is a fragrant and flavorsome dish that will stimulate your palate! Served with the highest quality beef, fused with the intense flavor of balsamic vinegar with a touch of the rich taste of red wine, umami of soy sauce, and mixed with the pungent taste of grated ginger. Sprinkled with salt and pepper to taste. A flavorful meal for healthful you!";
