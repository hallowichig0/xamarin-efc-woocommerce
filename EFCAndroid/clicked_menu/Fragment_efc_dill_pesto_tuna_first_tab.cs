...
{
    public class Fragment_efc_dill_pesto_tuna_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/DillPestoPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/DillPestoPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/DillPesto-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_dill_pesto_tuna_simple_pasta_first_tab, container, false);
            ...
            txtproduct_title.Text = "DILL PESTO TUNA WITH SIMPLE PASTA";
            txtprice.Text = "\n₱275.00";
            txtcontent.Text = "\nThe EFC Dill pesto tuna with simple pasta is a well-seasoned tuna fish fillet prepared with a beautiful blend of healthy herbs and spices. Tuna fillet is served elegantly with nuts, herbs and spices together with pasta. This dish is great for those who wish to stay healthy and fit with a perfect balance of carbohydrates, protein, and great taste.";
