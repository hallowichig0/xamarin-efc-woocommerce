...
{
    public class Fragment_efc_tofu_steak_mushroom_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/TofuSteakPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/TofuSteakPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/TofuSteakPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_tofu_steak_mushroom_first_tab, container, false);
            ...
            txtproduct_title.Text = "TOFU STEAK WITH MUSHROOM";
            txtprice.Text = "\n₱185.00";
            txtcontent.Text = "\nThe EFC Tofu steak with mushroom is the last promising dish for the vegan meals. Made with simple tofu smothered beautifully in sweet steak sauce and variety of herbs and spice with a side of well chopped potato wedges. This dish is simple and great for those who are always on the go.";
