...
{
    [Activity(Label = "Activity_EFC_BALSAMIC_BEEF_ONION_CONFIT_SERVED", /*MainLauncher = true,*/ Theme = "@style/Theme.DesignDemo")]
    public class Activity_EFC_BALSAMIC_BEEF_ONION_CONFIT_SERVED : AppCompatActivity
    {
        int[] imgview =
        {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_efc_balsamic_beef_onion_confit_served);

            mToolbar = FindViewById<SupportToolbar>(Resource.Id.toolbar);

            SetSupportActionBar(mToolbar);
            SupportActionBar.Title = "BALSAMIC BEEF WITH ONION CONFIT SERVED WITH MIX GREENS";
        ...
        private void SetUpViewPager(ViewPager viewpager)
        {
            ...
            adapter.AddFragment(new Fragment_efc_balsamic_beef_onion_confit_served_first_tab(), "Product");
        ...
        private void BottomNavView_NavigationItemSelected(object sender, BottomNavigationView.NavigationItemSelectedEventArgs e)
        {
            ...
            new System.Threading.Thread(new System.Threading.ThreadStart(delegate
            {
                ...
                try
                {
                    ...
                    MySqlCommand cmd_select = new MySqlCommand("select count(*) from wp_product_cart INNER JOIN wp_product_cart_add_ons ON wp_product_cart.session_order_id = wp_product_cart_add_ons.session_order_id where wp_product_cart.product_name = 'BALSAMIC BEEF WITH ONION CONFIT SERVED WITH MIX GREENS' AND wp_product_cart_add_ons.key_same_result = '1' AND wp_product_cart.customer_name = '" + session_user + "';", conn);
                    ...
                    if (count > 0)
                    {
                       ...
                       "WHERE wp_product_cart_add_ons.key_same_result = '1' AND wp_product_cart.product_name = 'BALSAMIC BEEF WITH ONION CONFIT SERVED WITH MIX GREENS' AND wp_product_cart.customer_name = '" + session_user + "';";
                    ...
                    else
                    {
                        ...
                        cmd_insert.Parameters.Add("@product_name", MySqlDbType.VarChar).Value = "BALSAMIC BEEF WITH ONION CONFIT SERVED WITH MIX GREENS";
                        ...
                        cmd_insert.Parameters.Add("@image", MySqlDbType.VarChar).Value = "http://earthfashioncafe.com/wp-content/uploads/2018/01/BalsamicBeefPackaging-180x180.png";
