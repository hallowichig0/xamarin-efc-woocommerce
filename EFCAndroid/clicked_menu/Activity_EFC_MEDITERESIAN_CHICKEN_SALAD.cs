...
{
    [Activity(Label = "Activity_EFC_MEDITERESIAN_CHICKEN_SALAD", /*MainLauncher = true,*/ Theme = "@style/Theme.DesignDemo")]
    public class Activity_EFC_MEDITERESIAN_CHICKEN_SALAD : AppCompatActivity
    {
        int[] imgview =
        {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_efc_mediteresian_chicken_salad);

            mToolbar = FindViewById<SupportToolbar>(Resource.Id.toolbar);

            SetSupportActionBar(mToolbar);
            SupportActionBar.Title = "MEDITERESIAN CHICKEN SALAD";
        ...
        private void SetUpViewPager(ViewPager viewpager)
        {
            ...
            adapter.AddFragment(new Fragment_efc_mediteresian_chicken_salad_first_tab(), "Product");
            ...
            new System.Threading.Thread(new System.Threading.ThreadStart(delegate
            {
                ...
                try
                {
                    ...
                    if (count > 0)
                    {
                       ...
                       "WHERE wp_product_cart_add_ons.key_same_result = '1' AND wp_product_cart.product_name = 'MEDITERESIAN CHICKEN SALAD' AND wp_product_cart.customer_name = '" + session_user + "';";
                    ...
                    else
                    {
                        ...
                        cmd_insert.Parameters.Add("@product_name", MySqlDbType.VarChar).Value = "MEDITERESIAN CHICKEN SALAD";
                        ...
                        cmd_insert.Parameters.Add("@image", MySqlDbType.VarChar).Value = "http://earthfashioncafe.com/wp-content/uploads/2018/01/MediteresianChickenPackaging-180x180.png";
