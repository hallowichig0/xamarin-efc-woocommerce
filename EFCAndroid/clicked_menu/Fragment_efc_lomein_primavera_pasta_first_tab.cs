...
{
    public class Fragment_efc_lomein_primavera_pasta_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/LoMeinPrimeveraPastaPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/LoMeinPrimeveraPastaPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/LoMeinPrimeveraPastaPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_lomein_primavera_pasta_first_tab, container, false);
            ...
            txtproduct_title.Text = "LO MEIN PRIMAVERA PASTA";
            txtprice.Text = "\n₱215.00";
            txtcontent.Text = "\nThe EFC Lo mein primavera pasta is another promising vegan meal with a great flavor. A well-prepared meal of fresh pasta seasoned in rich oyster sauce.Complemented by a variety of spices and mixed greens.This a very good treat for those who wish to follow a great vegan diet with a well-balanced meal.";
