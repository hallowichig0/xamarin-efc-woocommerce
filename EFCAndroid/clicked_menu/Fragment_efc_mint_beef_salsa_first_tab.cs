...
{
    public class Fragment_efc_mint_beef_salsa_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/MintBeefPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/MintBeefPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/MintBeef-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_mint_beef_salsa_first_tab, container, false);
            ...
            txtproduct_title.Text = "MINT BEEF WITH SALSA";
            txtprice.Text = "\n₱275.00";
            txtcontent.Text = "\nThe EFC Mint Beef with salsa is another fascinating and healthy dish that you should enjoy every single day! Prepared and cooked with high quality fresh beef that is seasoned with world class herb and spices. Imbued with garden-fresh mint that gives a sweet flavor in your mouth with a cool sensation. Fused with the citrusy taste of lime. Complimented with the fragrant, crisp, and scrumptious salsa that fits your need for a healthy balance meal. A juicy treat for you!";
