...
{
    public class Fragment_efc_roasted_chicken_funky_salad_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/RoastedChickenPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/RoastedChickenPackagingSideView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/RoastedChicken-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_roasted_chicken_funky_salad_first_tab, container, false);
            ...
            txtproduct_title.Text = "ROASTED CHICKEN WITH FUNKY SALAD";
            txtprice.Text = "\n₱245.00";
            txtcontent.Text = "\nThe EFC Roasted chicken with funky salad is one of the most promising dishes of all time. Served with a well marinated and roasted chicken breast, seasoned with special Italian seasoning and mustard. This meal is well complemented with a variety of mixed greens that will satisfy your cravings for healthy alternatives. This dish is great for those who wish to have a well-balanced meal with wonderful taste. The best dish for great class.";
