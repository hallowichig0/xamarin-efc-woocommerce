...
{
    [Activity(Label = "Activity_EFC_CHEESY_COLD_PASTA", /*MainLauncher = true,*/ Theme = "@style/Theme.DesignDemo")]
    public class Activity_EFC_CHEESY_COLD_PASTA : AppCompatActivity
    {
        int[] imgview =
        {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.activity_efc_cheesy_cold_pasta);

            mToolbar = FindViewById<SupportToolbar>(Resource.Id.toolbar);

            SetSupportActionBar(mToolbar);
            SupportActionBar.Title = "CHEESY COLD PASTA";
        ...
        private void SetUpViewPager(ViewPager viewpager)
        {
            ...
            adapter.AddFragment(new Fragment_efc_cheesy_cold_pasta_first_tab(), "Product");
            ...
            new System.Threading.Thread(new System.Threading.ThreadStart(delegate
            {
                ...
                try
                {
                    ...
                    if (count > 0)
                    {
                       ...
                       "WHERE wp_product_cart_add_ons.key_same_result = '1' AND wp_product_cart.product_name = 'CHEESY COLD PASTA' AND wp_product_cart.customer_name = '" + session_user + "';";
                    ...
                    else
                    {
                        ...
                        cmd_insert.Parameters.Add("@product_name", MySqlDbType.VarChar).Value = "CHEESY COLD PASTA";
                        ...
                        cmd_insert.Parameters.Add("@image", MySqlDbType.VarChar).Value = "http://earthfashioncafe.com/wp-content/uploads/2018/01/CheesyColdPastaPackaging-180x180.png";
