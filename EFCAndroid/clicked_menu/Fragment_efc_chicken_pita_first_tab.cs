...
{
    public class Fragment_efc_chicken_pita_first_tab : SupportFragment
    {
        ...
        string[] imgview_slider_main =
         {
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/GrilledChickenPitaSandwichPackaging-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/GrilledChickenPitaSandwichPackagingFrontView-600x600.png",
            "http://earthfashioncafe.com/wp-content/uploads/2018/01/GrilledChickenPitaSandwichPlating-600x600.png"
        };
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            View view = inflater.Inflate(Resource.Layout.fragment_efc_chicken_pita_first_tab, container, false);
            ...
            txtproduct_title.Text = "CHICKEN PITA";
            txtprice.Text = "\n₱155.00";
            txtcontent.Text = "\nEFC’s Chicken Pita is a jam-packed sandwich with mixed greens and pan-grilled breast chicken, flavoured with peanut butter filling and onion for additional spice inside the soft and chewy whole wheat pita bread.";
